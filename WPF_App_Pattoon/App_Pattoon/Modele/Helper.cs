...
namespace Wpf_App_Pattoon_Animalerie.Modele
{
    ...
    public static class LesMessage
    {
        ...
        public static string Q_Suppression => "Voulez-vous supprimer cette element";
    }
    ...
    public struct SCompatible
    {
        public Compatibilite _compatibilite;
        public string IsCompatible;
        public override readonly string ToString()
        {
            return $"{this._compatibilite.Nom} - {IsCompatible}" ;
        }
    }
